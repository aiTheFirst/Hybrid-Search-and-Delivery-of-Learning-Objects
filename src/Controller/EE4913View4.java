...
import Crawler.idWebCrawler.*;
import Crawler.fileWebCrawler.*;
 ...
 */
public class EE4913View4 extends FrameView {

    public EE4913View4(SingleFrameApplication app) {
        super(app);
        ...
        repoFilter = new RepositoryFilterAux();
        ...
        threadStatusTimer = new Timer(25, new ActionListener() {
            public void actionPerformed(ActionEvent e) {
               ...
               // jTranslatorThreadStatus.setText( abstractTranslator.getState().toString());
                ...
                jPersonalizationRepoFilterThreadStatus.setText(repoFilter.getState().toString());
    ...
    private void initComponents() {
        ...
        jPersonalizationRepoFilterThreadStatus = new javax.swing.JLabel();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(Controller.EE4913App.class).getContext().getResourceMap(EE4913View4.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(Controller.EE4913App.class).getContext().getActionMap(EE4913View4.class, this);
        jButton1.setAction(actionMap.get("webCrawlerStart")); // NOI18N
        jButton1.setText(resourceMap.getString("jButton1.text")); // NOI18N
        jButton1.setName("jButton1"); // NOI18N
        jButton1.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent evt) {
        EE4913View4.this.jButton1ActionPerformed(evt);
      }
    });
        ...
        //jPanel11.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), resourceMap.getString("jPanel11.border.title"))); // NOI18N
        ...
        //jPersonalizationOutputRepoDir.setText(resourceMap.getString("jPersonalizationOutputRepoDir.text")); // NOI18N
        //jPersonalizationOutputRepoDir.setName("jPersonalizationOutputRepoDir"); // NOI18N
...
//                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
//                            .addComponent(jPersonalizationRepoFilterThreadStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE))
//                        .addGroup(jPanel11Layout.createSequentialGroup()
//                            .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
//                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
//                            .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
//                                .addComponent(jPersonalizationInputRepoDir, javax.swing.GroupLayout.DEFAULT_SIZE, 285, Short.MAX_VALUE)
//                                .addComponent(jPersonalizationOutputRepoDir, javax.swing.GroupLayout.DEFAULT_SIZE, 285, Short.MAX_VALUE))))
//                    .addContainerGap())
//            );
...
//                        .addComponent(jLabel25)
//                        .addComponent(jPersonalizationInputRepoDir, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
//                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
//                    .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
//                        .addComponent(jLabel26)
//                        .addComponent(jPersonalizationOutputRepoDir, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
//                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
//                    .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
//                        .addComponent(jButton15)
//                        .addComponent(jButton16)
//                        .addComponent(jLabel24, javax.swing.GroupLayout.PREFERRED_SIZE, 19, javax.swing.GroupLayout.PREFERRED_SIZE)
//                        .addComponent(jPersonalizationRepoFilterThreadStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 19, javax.swing.GroupLayout.PREFERRED_SIZE))
//                    .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
//            );
...
//jButton1.setAction(actionMap.get("PersonalizationStart")); // NOI18N
    ...
    public void RepositoryFilter() {
        repoFilter.repoInputDir = jPersonalizationInputRepoDir.getText();
        repoFilter.repoOutputDir = jPersonalizationOutputRepoDir.getText();

        if(!repoFilter.isAlive()){
            repoFilter.start();
        }
    }

    public double GetPRelevence(UserProfile userProfile,String testXMLFilename, int topn){
        double ret = 0;

        List<CompareResult> list = personalizationApp.GetPersonalizationResults("res"+"\\"+"rulesJGS.xml",userProfile, testXMLFilename);

        if(topn > list.size()) topn = list.size();

        /* for each lom, multiply the kw frequency by the ruleresult */
        for(int i = 0; i < topn; i++){
            CompareResult cr = list.get(i);
            String lomName = cr.lo.LOName;
            double kwscore = 0;

            /* get the kwscore */
            if( LomScoreMap.containsKey(lomName) ){
                LOMScore ls = LomScoreMap.get(lomName);
                kwscore = ls.kwscore;
                ls.ruleresultscore = cr.score;
                //ls.pscore = cr.score * kwscore;
                ls.pscore = cr.score;

                ret += ls.pscore;
            }
            else{
                System.out.println("Personalization failed to find LOMName:" + lomName + " in scoremap!!");
            }
        ...
        for(int i = 0; i < topn; i++){
            ...
            System.out.println("PREL for: " + cr.lo.LOName + " is: " + cr.score);
        }
        */
    ...
    public double GetCKWRelevence(int topn){
        double ret = 0;
        if(loSearch == null){
            this.LOSearchStart();
            while(loSearch.isAlive()){
                try{
                    this.wait(2000);
                }
                catch(Exception e){}
        ...
        String[] ckwresults = loSearch.conceptResults;
        if(topn > ckwresults.length) topn = ckwresults.length;

        /* add score to map */
        for(int i = 0; i < ckwresults.length; i++){

            StringTokenizer st = new StringTokenizer(ckwresults[i]);
            double ckwscore = Double.parseDouble( st.nextToken() );
            String lomName = st.nextToken();

            /* is entry in map? */
            if( LomScoreMap.containsKey(lomName)){
                LomScoreMap.get(lomName).ckwscore = ckwscore;
            }
            else{
                /* make entry */
                LOMScore ls = new LOMScore();
                ls.ckwscore = ckwscore;

                LomScoreMap.put(lomName, ls);
            }
        ...
        for(int i = 0; i < topn; i++){
            StringTokenizer st = new StringTokenizer(ckwresults[i]);
            ret += Double.parseDouble( st.nextToken() );
        }

        return (ret);
    }

    public double GetKWRelevence(int topn){
        double ret = 0;
        ...
        //process now done. and its already sorted!
        String[] kwresults = loSearch.keywordResults;

        if(topn > kwresults.length) topn = kwresults.length;

        /* add score to map */
        for(int i = 0; i < kwresults.length; i++){

            StringTokenizer st = new StringTokenizer(kwresults[i]);
            double kwscore = Double.parseDouble( st.nextToken() );
            String lomName = st.nextToken();

            /* is entry in map? */
            if( LomScoreMap.containsKey(lomName)){
                LomScoreMap.get(lomName).kwscore = kwscore;
            }
            else{
                /* make entry */
                LOMScore ls = new LOMScore();
    ...
    public void BiletskiTest() {

        LomScoreMap = new HashMap<String,LOMScore>();

        // set query text

        String query = "assembly programming";
        jLOSearchQuery.setText(query);

        //String repo = "programming_repo"+"\\"+"qualifies"+"\\"+"abstracts";
        String repo = "mini_repo"+"\\"+"abstracts";
        jLOSearchAbstractDir.setText(repo);

        String userProfileFilename = "res"+"\\"+"User4JGS.xml";
        String targetProfileFilename = "res"+"\\"+"User1JGS.xml";
        //String testXMLFilename = "progLOTest.xml";
        String testXMLFilename = "miniLOTest.xml";

        UserProfile userProfile = new UserProfile(); userProfile.parseFromFile(userProfileFilename);
        UserProfile targetProfile = new UserProfile(); targetProfile.parseFromFile(targetProfileFilename);

        // get relevence for keyword search
        double kw_rel = GetKWRelevence(20);
        System.out.println("KWREL=" + kw_rel);

        // get relevence for concept + keyword search
        double ckw_rel = GetCKWRelevence(20);
        System.out.println("CKWREL=" + ckw_rel);

        // get relevence for personalized search
        double p_rel = GetPRelevence(userProfile,testXMLFilename,20);
        System.out.println("PREL="+p_rel);

        //adapt the profile
        personalizationApp.AdaptProfile("res"+"\\"+"rulesJGS.xml", userProfile, targetProfile, testXMLFilename);

        p_rel = GetPRelevence(userProfile,testXMLFilename,20);
        System.out.println("PREL(ADAPTED)="+p_rel);
    ...
    private javax.swing.JLabel jPersonalizationRepoFilterThreadStatus;
    ...
    private javax.swing.JTextField jPersonalizationInputRepoDir;
    private javax.swing.JTextField jPersonalizationOutputRepoDir;
    ...
    private RepositoryFilterAux repoFilter = null;
  ...
  //  stat.run();
      ...
      Map<String,LOMScore> LomScoreMap = null;
