...
public class ConceptVectorization {
...
//        WVTStemmer stemmer = new SynsetStemmer();
        ...
        WVTFileInputList list = new WVTFileInputList(5);

        
        /* Jarrett G. Steele
         * 
         * WVTDocumentInfo takes the query as a file. The GUI program will take the query as input, and write it to a file named query.txt.
        */
...
//        wordList.
        wordList.store(new FileWriter("wordlist.txt"));
